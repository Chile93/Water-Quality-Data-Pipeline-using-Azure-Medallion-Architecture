...
Browse the [`Screenshots/`](Screenshots/) folder for step-by-step visuals covering each stage of the pipeline, including:

- Azure Resource Group & Resources
- SQL Database exploration and user setup
- Azure Data Lake Storage Gen2 creation
- Logic App ingestion design
- Azure Data Factory orchestration
- Databricks Bronze, Silver, and Gold layer notebooks
- Lakeflow Declarative Pipelines (formerly Delta Live Tables)
- Power BI data loading and dashboard
